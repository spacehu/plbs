...
class SignDAL {
    ...
    public static function getAll($currentPage, $pagesize, $keywords,$enterprise_id,$openid=null,$questionnaire_id=null,$phone=null) {
        ...
        $sql = "select * from " . $base->table_name("sign") . " where `status`=1 and enterprise_id=" . $enterprise_id . $where ." limit ". $limit_start . "," . $limit_end . " ;";
        //echo $sql;die;
    ...
    public static function getTotal($keywords,$enterprise_id,$openid=null,$questionnaire_id=null,$phone=null) {
        ...
        $sql = "select count(1) as total from " . $base->table_name("sign") . " where `status`=1 and enterprise_id=" . $enterprise_id . $where . " limit 1 ;";
        //echo $sql;die;
