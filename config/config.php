...
return $config = [
    ...
    'restful_api' => [
        ...
        'path' => [
            ...
            'GET /v4/ApiCourse-categorys.htm' => 'v4-ApiCourse-categorys', //获取分类列表
            ...
            'GET /v4/ApiCourse-tests.htm' => 'v4-ApiCourse-tests', //获取试题列表
            'GET /v4/ApiCourse-test.htm' => 'v4-ApiCourse-test', //获取单个试题
            'POST /v4/ApiCourse-test.htm' => 'v4-ApiCourse-testing', //提交测试
